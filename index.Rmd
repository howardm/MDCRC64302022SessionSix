---
title: "Physician- Investigator & Patient-Participant Relationships."
subtitle: "MDCRC 6430 2022 - Session Six"
session: ""
...
A state of epistemic uncertainty in the community of relevant experts about the relative merits (considering both potential benefits and harms) of comparator interventions.
...
.pull-left[
![:scale 60%](images/Macklin.jpg)]

.pull-right[
![:scale 65%](images/LondonBook.jpg)]
...
.pull-left[
![:scale 1000%](images/NEJM1.jpg)]

.pull-right[
![:scale 100%](images/Criticism1.jpg)]
...
![:scale 60%](images/AngelEditorial.jpg)
...
.big[Notions of Standard of Care

* global *de jure* -- evidence-based standard


* local *de facto* -- what is actually done


* local *de jure*  -- From London:

> ...standard of care is determined by what conscientious and informed experts judge to be the most effective means of addressing a problem under conditions that are attainable and sutainable in the health systems in which the intervention in question will be deployed.]
...
Can one apply this "micro-level" concept of exploitation to interactions involving communities of people ?
...
.pull-left[
![:scale 70%](images/Wertheimer.jpg)]
...
> Given the nonideal background conditions under which people find themselves, there should be a very strong presumption in favor of principles that would allow people to improve their situations if they give appropriately robust consent, if doing so has no negative effects on others, and even if this interaction is unfair, unjust, or exploitative
]]
...
* the intervention (and/or ancillary procedures) may not be affordable in the host country(ies)
...
.big[About 90% of the global burden of premature mortality can be attributed to diseases that primarily affect populations of the developing world, but only 10% of the annual global research budget of $50 billion to $60 billion is targeted at those diseases.
]
...
.center[.big[.blue[International research, justice, and the human development approach]]]
...
.pull-left[
![:scale 100%](images/LondonSummary.jpg)]

.pull-right[
![:scale 50%](images/LondonBook.jpg)



Available as a PDF -- https://www.cmu.edu/dietrich/philosophy/docs/london/london-for-the-common-good.pdf -- as an open access title under terms of a CC-BY-NC-ND-4.0 license.
]
